import { isOpenDuring, isOpenOnDay } from './hours';
 ...
 * closed on arrival, or a day that overruns the budget. Keeping feasibility in
 * one place means the search below cannot accidentally produce an invalid plan.
 */
function buildTimeline(order: readonly Candidate[], req: SolveRequest): Timeline | null {
